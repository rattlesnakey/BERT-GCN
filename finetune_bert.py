...
#! 这边这两个是ignite的metric对象
metrics={
    'acc': Accuracy(),
    'nll': Loss(th.nn.CrossEntropyLoss())
}
#! 这边是把这个metric对象绑定到evaluator上面
...
def log_training_results(trainer):
    ...
    #! 在每个epoch这里会回调这个log_training_results, 里面就用到了evaluator
